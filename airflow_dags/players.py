...
PLAYERS_BQ_SCHEMA = [
    ...
    {'name': 'acceleration', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'sprint_speed', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'agility', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'reactions', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'balance', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'shot_power', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'jumping', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'stamina', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'strength', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'long_shots', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'aggression', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'interceptions', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'positioning', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'vision', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'penalties', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'composure', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'defensive_awareness', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'standing_tackle', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'sliding_tackle', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'gk_diving', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'gk_handling', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'gk_kicking', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'gk_positioning', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'gk_reflexes', 'type': 'INTEGER', 'mode': 'NULLABLE'},
    {'name': 'processed_at', 'type': 'DATETIME', 'mode': 'NULLABLE'}
]
